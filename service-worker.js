/*
 * service-worker.js — offline shell cache for the serverless "22" PWA.
 *
 * Serverless design: the data lives in a GitHub Gist (gist-store.js talks to
 * api.github.com directly). This SW only caches the static shell for offline
 * and lets gist API calls pass through to the network (cache-busted by the app).
 *
...
const CACHE = 'aligners-v2';
const SHELL = [
  './', './index.html', './styles.css', './app.js', './wear-core.js', './gist-store.js',
